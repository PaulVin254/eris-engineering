...
const HeroSection = () => {
  ...
  const navItems = [
    ...
    { id: 'phone', label: '+254 700 123 456', onClick: () => window.open('tel:+254700123456') },
    { id: 'consultation', label: 'Free Consultation', onClick: () => console.log('Free consultation clicked') },
  ];
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 text-center lg:text-left">
            ...
            <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-sm font-medium text-foreground">61% of diaspora fear fraud when building in Kenya</span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-lg text-foreground">Live progress updates via WhatsApp</span>
              </div>
              <div className="flex items-center space-x-4">
                <CheckCircle className="w-6 h-6 text-orange-500 flex-shrink-0" />
                <span className="text-lg text-foreground">Money-back guarantee</span>
              </div>
              <div className="flex items-center space-x-4">
                <CheckCircle className="w-6 h-6 text-orange-500 flex-shrink-0" />
              ...
              <div className="flex items-center space-x-4">
                <CheckCircle className="w-6 h-6 text-orange-500 flex-shrink-0" />
                <span className="text-lg text-foreground">Professional oversight</span>
              </div>
            </div>
